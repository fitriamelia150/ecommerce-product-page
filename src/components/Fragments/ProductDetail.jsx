...
import { addItemQty, deleteItemQty } from "../../redux/slices/cartSlice"
        ...
        <div className="p-5 font-kumbh">
            ...
            <div className="mt-5 flex flex-col gap-4 ">
                <div className="flex justify-between items-center bg-light-grayish-blue p-5 rounded-md">
                    <img src="/images/icon-minus.svg" alt="icon-minus" className="cursor-pointer" onClick={() => dispatch(deleteItemQty({title:data.title}))}/>
                    <p className="font-bold">{qty}</p>
                    <img src="/images/icon-plus.svg" alt="icon-plus" className="cursor-pointer" onClick={() => dispatch(addItemQty({title:data.title, price:data.price, qty:1}))}/>
                </div>
